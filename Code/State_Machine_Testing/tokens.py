...
lists = [types, numbers, brackets, keywords, variables, operators, punctuation, actor_names, state_names, variable_names]
names = ['Types', 'Numbers', 'Brackets', 'Keywords', 'Variables', 'Operators', 'Punctuation', 'Actor_Names', 'State_Names', 'Variable_Names']
